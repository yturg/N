...
import com.xin.mynews.ui.message.presenter.MessagePresenter;
...
public class MessageDetailFragment extends BaseFragment<MessagePresenter> implements MessageContract.View {
    ...
    public MessageDetailFragment(BaseQuickAdapter baseQuickAdapter) {
        this.mAdapter = baseQuickAdapter;
    }

    public static MessageDetailFragment newInstance(String type, BaseQuickAdapter baseQuickAdapter){
        Bundle args = new Bundle();
        args.putCharSequence(TYPE,type);
        MessageDetailFragment fragment = new MessageDetailFragment(baseQuickAdapter);
